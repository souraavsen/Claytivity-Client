...
* On the homepage, section users can see products at a glance. People can easily purchase them through minimal steps.
...
* Users will be able to check out their orders and if the orders are not shipped they will be able to cancel them as well.
* In the Dashboard, section users will be able to see their total amount of spending on this site for buying items also a short overview of the pending orders.

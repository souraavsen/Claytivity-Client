    ...
    <div className='mx-auto'>
      <div className='mt-10 z-0 px-2 pb-4 bg-white border-2 flex flex-col items-center justify-center shadow-md rounded-bl-xl rounded-br-xl'>
        ...
        <div className='flex justify-between items-center -mt-12'>
          <h2 className='text-center px-4 py-1 ml-6 font-bold text-white text-lg bg_mud rounded-tl-lg rounded-br-lg'>
            Potter Name
          </h2>
          <div className='price mb-8 ml-6 left-3/4'>
            <p className='text-base font-extrabold flex'>
              {/* Price: */}
              <span className='max-w-32 text-sm text-black pl-5 pr-3 bg_price py-1'>
                $ 106.55
              </span>
            </p>
          </div>
        </div>
        <h2 className='text-justify px-4 text-sm'>
          ...
          veritatis. Iure fuga ratione odio laudantium consequatur. Mollitia
          architecto magnam expedita eos iste quia, et in sit, explicabo natus a
          nobis vitae tenetur.
        </h2>
        <div>

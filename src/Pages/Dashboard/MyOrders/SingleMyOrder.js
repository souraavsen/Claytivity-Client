...
const SingleMyOrder = () => {
  return (
    <div>
      <div class='max-w-lg lg:flex justify-center rounded-tl-lg rounded-tr-lg rounded-br-lg'>
        <div class='order_card h-48 lg:h-auto lg:w-48 flex-none text-center overflow-hidden'></div>
        <div class='border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal'>
          <div class='mb-2'>
            ...
            <div class='text-gray-900 font-bold text-xl mb-2'>Can coffee</div>
            <p class='text-gray-700 '>TransictionID:A54ADASD7156DSD</p>
            <p class='text-gray-700 '>Contact:01765414858</p>
          </div>
